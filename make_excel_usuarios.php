...
$headers = [
    'nombre', 'apellidos', 'identificacion', 'genero', 'correo',
    'numero_celular', 'area', 'rol', 'fecha_nacimiento', 'fecha_contratacion'
];
...
$outputFile = __DIR__ . '/plantilla_cargue_masivo_usuarios.xlsx';
